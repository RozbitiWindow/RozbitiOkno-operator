...
class Program
{
    ...
    static void Main()
    {
        ...
        while (true)
        {
            ...
            if (whattodo != 0 && whattodo != 1 && whattodo != 2 && whattodo != 3 && whattodo != 4 && whattodo != 5 && whattodo != 111 && whattodo != 67 && whattodo != 420 && whattodo != 1337 && whattodo != 6 && whattodo != 7 && whattodo != 8 && whattodo != 9)
            {
